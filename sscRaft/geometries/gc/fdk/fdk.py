...
def reconstruction_fdk( experiment, data, flat = {}, dark = {}):
    ...
    Dictionary parameters:
        ...
        *``experiment['normalize']`` (bool,bool,int,int): Tuple flag for normalization of projection data. ( normalize = True , use log to normalize = True, total number of frames acquired, index of initial frame to process).
    ...
    # Frames correction by flat and dark and Correction of rotation Axis
