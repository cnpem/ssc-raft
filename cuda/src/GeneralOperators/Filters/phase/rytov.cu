...
extern "C" {
	...
	void _rytov_gpu(PAR param, float *projections, size_t nrays, size_t nangles, size_t nslices)
    {
        ...
        rytovPrep<<<param.Grd,param.BT>>>(d_sino, param, nrays, nslices, nangles);

        rytovKernel<<<param.Grd,param.BT>>>(kernel, param, param.Npadx, param.Npady, nangles);
