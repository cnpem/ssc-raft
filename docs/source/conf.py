...
# get conf.py path then return 2 folders
folder_path = '../../sscRaft/'
# sys.path.insert(0, os.path.abspath(folder_path))
# sys.path.insert(0, os.path.abspath(folder_path2))
...
autodoc_mock_imports = ["sscRadon", "sscBst", "cupy", "h5py","SharedArray"] # list all modules to be ignored during compilation of the html 
